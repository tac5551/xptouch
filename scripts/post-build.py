...
def post_build_create_ota_json(version_value):
    ...
    with open(f"../xptouch-bin/2.8/ota/xptouch.{version_value}.json", "w") as ota_versioned_file:
...
def post_build_copy_ota_fw(version):
    ...
    ota_elf_source = "./.pio/build/esp32dev/firmware.elf"
    ota_elf_target = f"../xptouch-bin/2.8/ota/xptouch.{version}.elf"
