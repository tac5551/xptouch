 ...
 */
#ifndef _XPTOUCH_AMS_EDIT_TEMP_H
#define _XPTOUCH_AMS_EDIT_TEMP_H
...
void xptouch_debug_log_ams_save(const char *id_buf, const char *fetched_id, int id_match, int fetched_min, int fetched_max, int payload_min, int payload_max);
