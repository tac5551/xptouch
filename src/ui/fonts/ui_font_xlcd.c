...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 557, .adv_w = 0, .box_w = 0, .box_h = 0, .ofs_x = 0, .ofs_y = 0}  /* 4 0byte */,
    {.bitmap_index = 557, .adv_w = 384, .box_w = 24, .box_h = 25, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 707, .adv_w = 384, .box_w = 22, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 828, .adv_w = 384, .box_w = 22, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 949, .adv_w = 384, .box_w = 23, .box_h = 20, .ofs_x = 1, .ofs_y = 1},
    {.bitmap_index = 1064, .adv_w = 384, .box_w = 21, .box_h = 20, .ofs_x = 2, .ofs_y = 1},
    {.bitmap_index = 1169, .adv_w = 384, .box_w = 21, .box_h = 23, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 1290, .adv_w = 384, .box_w = 21, .box_h = 21, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1401, .adv_w = 384, .box_w = 24, .box_h = 22, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 1533, .adv_w = 384, .box_w = 24, .box_h = 21, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1659, .adv_w = 384, .box_w = 24, .box_h = 21, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 1785, .adv_w = 384, .box_w = 18, .box_h = 23, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 1889, .adv_w = 384, .box_w = 22, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2010, .adv_w = 384, .box_w = 21, .box_h = 26, .ofs_x = 2, .ofs_y = 1},
    {.bitmap_index = 2147, .adv_w = 384, .box_w = 23, .box_h = 23, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 2280, .adv_w = 384, .box_w = 22, .box_h = 17, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 2374, .adv_w = 384, .box_w = 16, .box_h = 22, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 2462, .adv_w = 384, .box_w = 24, .box_h = 24, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 2606, .adv_w = 384, .box_w = 24, .box_h = 25, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 2756, .adv_w = 384, .box_w = 24, .box_h = 24, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 2900, .adv_w = 384, .box_w = 24, .box_h = 24, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 3044, .adv_w = 384, .box_w = 25, .box_h = 23, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 3188, .adv_w = 384, .box_w = 25, .box_h = 23, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 3332, .adv_w = 384, .box_w = 18, .box_h = 23, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 3436, .adv_w = 384, .box_w = 22, .box_h = 19, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 3541, .adv_w = 384, .box_w = 24, .box_h = 18, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 3649, .adv_w = 384, .box_w = 20, .box_h = 25, .ofs_x = 3, .ofs_y = -1}
};
