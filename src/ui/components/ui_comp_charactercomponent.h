...
enum CharacterComponent {
    UI_COMP_CHARACTERCOMPONENT_CHARACTERCOMPONENT,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_FACE,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_LEFTEAR,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_RIGHTEAR,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_LEFTEARINNER,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_RIGHTEARINNER,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_LEFTEYE,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_RIGHTEYE,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_NOSE,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_MOUTH,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_TAIL,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_STATUSLABEL,
    UI_COMP_CHARACTERCOMPONENT_CHARACTERFACE_MOODLABEL,
    _UI_COMP_CHARACTERCOMPONENT_NUM
};
