...
#define UI_COMP_SIDEBARCOMPONENT_SIDEBARAMSVIEWBUTTON 9 
#define UI_COMP_SIDEBARCOMPONENT_SIDEBARAMSVIEWBUTTON_SIDEBARAMSVIEWBUTTONICON 10
#define UI_COMP_SIDEBARCOMPONENT_SIDEBARSETTINGSBUTTON 11
#define UI_COMP_SIDEBARCOMPONENT_SIDEBARSETTINGSBUTTON_SIDEBARSETTINGSBUTTONICON 12
