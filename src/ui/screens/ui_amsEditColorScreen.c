/**
 * AMS Edit 色選択画面: コンポーネントでパレット＋Back を表示
 */
#include "../ui.h"
...
void ui_amsEditColorScreen_screen_init(void)
{
    ...
    lv_obj_set_style_pad_left(ui_amsEditColorScreen, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_amsEditColorScreen, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_amsEditColorScreen, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_amsEditColorScreen, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_row(ui_amsEditColorScreen, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_column(ui_amsEditColorScreen, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_sidebarComponent = ui_sidebarComponent_create(ui_amsEditColorScreen);
    lv_obj_set_x(ui_sidebarComponent, 387);
    lv_obj_set_y(ui_sidebarComponent, 178);

    lv_obj_t *content_col = lv_obj_create(ui_amsEditColorScreen);
    ...
    ui_amsEditColorComponent = ui_amsEditColorComponent_create(content_col);
    lv_obj_set_width(ui_amsEditColorComponent, lv_pct(100));
    lv_obj_set_flex_grow(ui_amsEditColorComponent, 1);
    lv_obj_set_x(ui_amsEditColorComponent, 0);
    lv_obj_set_y(ui_amsEditColorComponent, 0);
