...
void ui_utilNozzleChangeScreen_screen_init(void)
{
    ...
    ui_sidebarComponent = ui_sidebarComponent_create(ui_utilNozzleChangeScreen);
    lv_obj_set_x(ui_sidebarComponent, 387);
    lv_obj_set_y(ui_sidebarComponent, 178);

    lv_obj_t *content_col = lv_obj_create(ui_utilNozzleChangeScreen);
    ...
    ui_utilNozzleChagneComponent = ui_utilNozzleChagneComponent_create(content_col);
    lv_obj_set_width(ui_utilNozzleChagneComponent, lv_pct(100));
