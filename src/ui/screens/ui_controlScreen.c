...
void ui_controlScreen_screen_init(void)
{
    ...
    lv_obj_t *content_col = lv_obj_create(ui_controlScreen);
    ...
    ui_utilTabbarComponent_create(content_col, UI_UTILTABBAR_TAB_AXIS);

    ui_controlComponent = ui_controlComponent_create(content_col);
    lv_obj_set_width(ui_controlComponent, lv_pct(100));
