...
| 値 | 定数名 | 意味 |
|----|--------|------|
| 0 | XPTOUCH_PRINT_STATUS_IDLE | アイドル |
| 1 | XPTOUCH_PRINT_STATUS_RUNNING | 印刷中 |
| 2 | XPTOUCH_PRINT_STATUS_PAUSED | 一時停止 |
| 3 | XPTOUCH_PRINT_STATUS_FINISHED | 完了 |
| 4 | XPTOUCH_PRINT_STATUS_PREPARE | 準備中 |
| 5 | XPTOUCH_PRINT_STATUS_FAILED | 失敗 |
...
- LED 分岐: `neopixel.h` の `XPTOUCH_PRINT_STATUS_RUNNING` 内の `print_gcode_action` 判定
