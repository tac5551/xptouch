...
**このプロジェクトではタッチUIを持たないBambulab P1Sをメインターゲットに開発しています。**

P1シリーズ用にチューニングをしています。
1.8以降にアップグレードされた個体では使用できません。BambuHandyからダウングレードが必要となります。
**派生元のxtouchの機能としてLanOnlyモード動作もサポートしています**
Vesion 1.9以降のファームウェアの場合にはLanOnlyモードに切り替えLAN接続する必要があります。
1.9以降でクラウド接続した場合BambuCloud側の制限によりデータの取得はできるが、ほとんどすべての操作ができません。

- LanOnlyモード設定手順: [LanOnly Mode | Bambu Lab Wiki](https://wiki.bambulab.com/en/knowledge-sharing/enable-developer-mode)
- ダウングレード手順: [Firmware Downgrade | Bambu Lab Wiki](https://wiki.bambulab.com/en/knowledge-sharing/firmware-downgrade)
- ローカルモード接続: `xtouch.json` を作成して SD カードのルートに配置してください<br>　　　（設定ツール）: [localOnly setteing : tac-lab.tech](https://tac-lab.tech/xptouch-bin/localOnly.html)

**バージョン 0.0.60 以降では AMS エディタ機能が追加されています。<br>
この機能を利用するには、xptouch 本体のファームウェア更新に加えて、Chrome 拡張機能も最新版へ更新してください。**

X1C、X1EおよびP2S / H2S / A1シリーズなども、**おそらく動作可能です**自己責任でお使いください。
これらの機種は標準のタッチパネルを持っているため、追加のメリットがあまりないため、メインターゲットとしていません。

**P2S/ X2D / H2D / H2C についてはBambu側の制限によりLANモード専用サポート**です。<br>
（クラウド経由の場合情報取得ができません）
...
2. [セットアップとインストール](#セットアップとインストール)
   ...
   - [Bambulabアカウントとの紐づけ](#bambulabアカウントとの紐づけ)
   - [初回プロビジョニング](#初回プロビジョニング)
   - [トークン更新](#トークン更新)
   - [LAN Only Mode](#lan-only-mode--lan-only-mode)
   - [タッチパネルのキャリブレーション](#タッチパネルのキャリブレーション)
   - [プリンターのリンク](#プリンターのリンク)
3. [bambulab-p1sへの取り付け](#bambulab-p1sへの取り付け)
4. [スクリーン](#スクリーン)
   - [メインスクリーン](#メインスクリーン)
   - [温度/ファンスクリーン](#温度ファンスクリーン)
   - [制御スクリーン](#制御スクリーン)
   - [フィラメントスクリーン](#フィラメントスクリーン)
   - [設定スクリーン](#設定スクリーン)
5. [アップデート](#アップデート)
   - [OTAアップデート手順](#otaアップデート手順)
   - [SDファームウェアアップデート](#sdファームウェアアップデート)
6. [トラブルシューティング](#トラブルシューティング)
7. [5インチ LCD / Bus 設定（JC8048W550・lcd.json）](#5インチ-lcd--bus-設定jc8048w550・lcdjson)
8. [開発環境のセットアップ（ファームウェアのビルドを行う場合）](#開発環境のセットアップファームウェアのビルドを行う場合)
...
Xtouch Liteをベースに、手頃な価格のCYD呼ばれる開発ボードで動作するように拡張しています。
用途や入手性に合わせて、選択できます。
...
|ボード|画面サイズ|温度センサー|NexpixelLED|バッテリ|購入先|備考|
|---|---|---|---|---|---|---|
|2432S028R|2.8(240 x 320)|**Yes**|**Yes**|No| [購入リンク](https://s.click.aliexpress.com/e/_c3fGqpNT)
|2432S028R(USB-C)|2.8(240 x 320)|**Yes**|**Yes**|No | [購入リンク](https://s.click.aliexpress.com/e/_c36MHgF7) 
|JC2432W328R|2.8(240 x 320)|**Yes**|**Yes**|**Yes**| [購入リンク](https://s.click.aliexpress.com/e/_c3V5Eyjj) 
|JC2432W328C|2.8(240 x 320)|**Yes**|**Yes**|**Yes**| [購入リンク](https://s.click.aliexpress.com/e/_c3V5Eyjj) 
|2432S024C|2.4(240 x 320)|**Yes**|**Yes**|No| [購入リンク](https://ja.aliexpress.com/item/1005012039563169.html) |未検証|
|2432S032|3.2(240 x 320)|**Yes**|**Yes**|No| [購入リンク](https://s.click.aliexpress.com/e/_c4miViDf) |未検証|
|3248S35C|3.5(320 x 480)|**Yes**|**Yes**|No|[購入リンク](https://s.click.aliexpress.com/e/_c4oUvBW5)
|JC3248W535R|3.5(320 x 480)|**Yes**|**Yes**|**Yes**|販売終了？ ||
|JC3248W535C|3.5(320 x 480)|**Yes**|**Yes**|**Yes**|販売終了？ ||
|E32-28T(ILI9341V)|2.8(240 x 320)|No|No|**Yes**|[購入リンク](https://s.click.aliexpress.com/e/_c3p4BdEb)|Option未対応
|E32-28T(ST7789)|2.8(240 x 320)|No|No|**Yes**|[購入リンク](https://s.click.aliexpress.com/e/_c3p4BdEb)|Option未対応
|E32-32T|3.2(240 x 320)|No|No|**Yes**|[購入リンク](https://s.click.aliexpress.com/e/_c3p4BdEb)|Option未対応
|E32-35T|3.5(320 x 480)|No|No|**Yes**|[購入リンク](https://s.click.aliexpress.com/e/_c3p4BdEb)|Option未対応
|E32-40T|4.0(320 x 480)|No|No|**Yes**|[購入リンク](https://s.click.aliexpress.com/e/_c3p4BdEb)|Option未対応
---
* XPTouch(800x480) 推奨ボード

|ボード|画面サイズ|温度センサー|NexpixelLED|バッテリ|購入先|備考|
|---|---|---|---|---|---|---|
|JC8048W550|5.0(800 x 480)|**Yes**|**Yes**|**Yes**|[購入リンク](https://s.click.aliexpress.com/e/_okFyaE4) |
|JC3248W535|3.5(320 x 480)|**Yes**|**Yes**|**Yes**|[購入リンク](https://s.click.aliexpress.com/e/_c4U8xDFH) |
|ES3N28P|2.8(240 x 320)|**Yes**|**Yes**|**Yes**|[購入リンク](https://ja.aliexpress.com/item/1005010314204776.html)|
|8048S043|4.3(800x480)|**Yes**|**Yes**| No |[購入リンク](https://s.click.aliexpress.com/e/_c3q54KiD)|未検証|
|8048S050|5.0(800x480)|**Yes**|**Yes**| No |[購入リンク](https://s.click.aliexpress.com/e/_c4qhBxsZ) |未検証|
...
| ------- | -------- | ----------------------- | -------- | --------------------------------------------------- |
| **1** | IPistBit | ESP-32E(3.5 with touch) | 3.5 inch(480x320) | [購入リンク](https://s.click.aliexpress.com/e/_c3IEJhcZ) |
| **2** | IPistBit | ESP-32E(4.0 with touch) | 4.0 inch(480x320) | [購入リンク](https://s.click.aliexpress.com/e/_c3IEJhcZ) |
| **3** | GUITION | 8048S070 | 7.0 inch (800x480)  | [購入リンク](https://s.click.aliexpress.com/e/_c4OgPvgh) |
...
#### GPIO 配線
  ...
  信号線への接続先ポートはSetting-＞Optionから確認できます。<br>**使用しているボードにより異なる場合があるので必ず確認してから接続してください**

- **2.8インチ環境**
 - **DS18B20**: 信号線 → GPIO22<br>3.3V / GND は基板の 3.3V / GND に接続し、4.7kΩ で信号線と 3.3V をプルアップしてください。 
 

 - **NeoPixel**: 信号線 → **GPIO21**<br>5V 給電時も信号は 3.3V ロジックを前提にしてください。 
 
温度センサーは以下のリンクで購入できます：

- [DS18B20 温度センサーB](https://s.click.aliexpress.com/e/_oBYP2pE)
- **DS18B20 P1P/P1Sチャンバー温度エンクロージャー**: さらに、DS18B20温度センサーをP1P/P1Sプリンター内に簡単に統合できる3Dモデルがあります。
3Dモデルは以下のリンクで見つけることができます： 


|モデル名|イメージ|リンク|
|---|---|---|
|モデルA|<img src="https://github.com/xperiments-in/xtouch/assets/417709/a8d14564-09e9-4d36-9ad9-10fd8f295c86" width="300">|[makerworld](https://makerworld.com/en/models/19658)
|モデルB|<img src="https://github.com/xperiments-in/xtouch/assets/417709/22871bdf-ba37-44f0-a4b3-33c6352f7f86" width="300">| [makerworld](https://makerworld.com/en/models/42533) 
...
1. **拡張機能のダウンロード**このリンクをクリックしてChrome拡張機能をダウンロードしてください：<br>
...
[設定ページ](https://tac-lab.tech/xptouch-bin/localOnly.html)でxtouch.jsonを作成してください<br>
...
|画面|画像|説明|備考|
|---|---|---|---|
|Home|<img src="tool/icon_export/ui_font_xlcd48/icon_a_0061.bmp">|メインスクリーンを表示します。|
|Printers|<img src="tool/icon_export/ui_font_xlcd48/icon_B_0042.bmp">|BambuCloudに紐づけられたプリンタを一括監視できます|ESP32-S3ボードでのみ動作します。<br>LanOnlyモードでは使用で来ません
|History|<img src="tool/icon_export/ui_font_xlcd48/icon_C_0043.bmp">|BambuCloudの印刷履歴から再印刷ができます|ESP32-S3ボードでのみ動作します。<br>LanOnlyモードでは使用で来ません
|Camera|<img src="tool/icon_export/ui_font_xlcd48/icon_y_0079.bmp">|内臓カメラに接続します|**P1/A1シリーズ専用。**<br>ESP32-S3ボードでのみ動作します。<br>同一ネットワーク内のみで動作します。
|Axis/Temp/Fan|<img src="tool/icon_export/ui_font_xlcd48/icon_p_0070.bmp">|プリンタの各種操作、ファンの速度設定などができます。|
|Filaments|<img src="tool/icon_export/ui_font_xlcd48/icon_n_006E.bmp">|AMSおよびExternalのフィラメント設定・操作ができます。
|Settings|<img src="tool/icon_export/ui_font_xlcd48/icon_d_0064.bmp">|各種xptouchの設定ができます|
...
## 5インチ LCD / Bus 設定（JC8048W550・lcd.json）
